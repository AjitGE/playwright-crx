...
commandWithOpenOptions('codegen [url]', 'open page and generate code for user actions',
    [
      ...
      ['--target <language>', `language to generate, one of javascript, playwright-test, python, python-async, python-pytest, csharp, csharp-mstest, csharp-nunit, java, java-junit, java-testng`, codegenId()],
