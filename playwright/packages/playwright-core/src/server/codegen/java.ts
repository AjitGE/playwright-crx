...
type JavaLanguageMode = 'library' | 'junit' | 'testNg';
...
export class JavaLanguageGenerator implements LanguageGenerator {
  ...
  generateAction(actionInContext: actions.ActionInContext): string {
    ...
    let subject = `${pageAlias}${locators.join('')}`;
    ...
    if(this._mode === 'testNg') {
      subject = subject.replace('page','this.pageController.getPage()');
    }
  ...
  generateHeader(options: LanguageGeneratorOptions): string {
    ...
    else if (this._mode === 'testNg') {
      formatter.add(`import com.microsoft.playwright.junit.UsePlaywright;
      import com.microsoft.playwright.Page;
      import com.microsoft.playwright.options.*;
  ...
  generateFooter(saveStorage: string | undefined): string {
    ...
    if (this._mode === 'junit' || this._mode === 'testNg') {
